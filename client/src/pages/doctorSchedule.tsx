        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-6 py-12">
            <div className="max-w-md w-full">
                <div className="text-center mb-10">
                    ...
                    <h2 className="text-3xl font-bold text-gray-900 mb-2">Doctor Schedule</h2>
                    <p className="text-gray-600">Configure your appointment availability</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8">
                    <div className="space-y-5">
                        ...
                        <div className="text-center text-sm text-gray-600 bg-teal-50 p-4 rounded-lg">
                            ...
                            <p>Your schedule will be available for patients to book appointments during the configured time slots.</p>
                        </div>
                    </div>
                    ...
                    {formData.week_day_id && formData.start_time && formData.end_time && (
                        <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <h3 className="text-sm font-semibold text-gray-700 mb-3">Schedule Preview</h3>
                            <div className="space-y-2 text-sm text-gray-600">
                                <div className="flex justify-between">
                                    <span>Day:</span>
                                    <span className="font-medium text-gray-900">
                                        {weekDays.find(d => d.id === formData.week_day_id)?.name || '-'}
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Time:</span>
